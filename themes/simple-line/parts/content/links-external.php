<div class="content--links-external">
  <ul class="list--links">
    <li class="list__item"><a class="link--button github" href="<?php echo GITHUB_URL; ?>" target="_blank">Github</a></li>
    <li class="list__item"><a class="link--button facebook" href="<?php echo FACEBOOK_URL; ?>" target="_blank">Facebook</a></li>
